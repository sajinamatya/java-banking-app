...
public class Creditcard extends Bankcard
{
    ...
    public Creditcard(int card_Id, String client_Name, String issuer_Bank, String bank_Account,
    int balance_Amount, int cvc_Number, double interest_Rate, String expiration_Date){
        ...
        setBalance_Amount(balance_Amount);
    ...
    {
        if(this.credit_Limit <= 2 * getBalance_Amount()){
            is_Granted = true;
